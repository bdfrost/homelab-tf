...
variable "ssh_public_key" {
  description = "The SSH public key to add the authorized_keys file of the default user on the Kubernetes nodes."
  type        = string
}

variable "ssh_private_key" {
  description = "The private SSH that Terraform will use to SSH into the Kubernetes nodes."
  type        = string
}
